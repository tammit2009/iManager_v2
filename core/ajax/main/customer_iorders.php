...
// Add a inline order line item
if (isset($_POST["get_new_iorder_item"])) {
...
if (isset($_POST["get_iorder_item_details"])) {
...
// Capture and store inline order
if (isset($_POST["createInlineOrder"]) AND isset($_POST["iorder_attendant_id"])) {
