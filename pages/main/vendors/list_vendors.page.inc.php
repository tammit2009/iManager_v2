...
<div class="dashboard card my-2">
    <div class="card-header bg-white">
        <div class="card-header-panel d-flex align-items-center justify-content-between">
            <h3 class="my-0">Vendors</h3>
            <a href="./main.php?dir=vendors&page=add_vendor" class="btn btn-block btn-sm btn-default btn-flat border-info">
    ...
    <div class="card-body">
        ...
        <?php if ($vendors == -1 || empty($vendors)) {
            echo "No Record Found"; exit;
        } ?>
        
        <table class="table tabe-hover table-bordered table-users" id="listVendors">
                ...
                <tr role="row" class="odd">
                    ...
                    <td class="text-center">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="./main.php?dir=vendors&page=edit_vendor&amp;id=<?php echo $row['id']; ?>">Edit</a>
                            <div class="dropdown-divider"></div>
...
$(document).ready(function(){
    ...
    $('#listVendors').DataTable();     // initialize the datatable

    // View Vendor
    $('.view_vendor').click(function(){
        // pull in the html view page with uni_modal
		uni_modal("<i class='fa fa-id-card'></i> Vendor Details", "main/vendors/inc/view_vendor.php?id=" + $(this).attr('data-id'));
	});

    // Delete Org
    $('#listVendors').delegate('.delete_vendor', 'click', function(e) {
        doConfirm("Are you sure to delete this vendor?", "deleteVendor", [ $(this).attr('data-id') ])
    })
});
