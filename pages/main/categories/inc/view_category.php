...
if(isset($_GET['id'])){
    $category = fetchCategoryById($_GET['id']);
	...
	<!-- <div class="card"> -->
        ...
        <div class="card-body">
            <table style="font-size:14px;width:100%;">
                ...
                <tr>
                    <td class="field-key">ParentID:</td>
                    <td><b><span><?php echo $parent_id ?></span></b></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="field-key">Category Image:</td>
                    <td><b><span><?php echo $cat_image ?></span></b></td>
                </tr>
                <tr>
