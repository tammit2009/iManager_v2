<?php 
    if (isset($_GET['startp']) && (isset($_GET['endp']))) {
        $ims_requests = fetch_ims_requests($_GET['startp'], $_GET['endp']);
    }
    else {
        $ims_requests = fetch_ims_requests(date("Y-m-d",strtotime("-3 days")), date("Y-m-d"));
    }
?>
    ...
    <div class="col-md-12">
        ...
        <div class="dashboard card my-2">
            ...
            <div class="card-body">
                ...
                <?php 
                if ($ims_requests == -1 || empty($ims_requests)) {
                ...
                <table class="table table-hover table-bordered table-products" id="listStockTxns">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="width: 12%;">Request Date</th>
                            <th class="text-center" style="width: 10%;">Source</th>
                            <th class="text-center" style="width: 10%;">Target</th>
                            <th class="text-center" style="width: 10%;">Request Type</th>
                            <th class="text-center" style="width: 7%;">Category</th>
                            <th class="text-center" style="width: 15%;">Activity</th>
                            <th class="text-center" style="width: 7%;">RecordId</th>
                            <th class="text-center" style="width: 7%;">Operation</th>
                    ...
                    <tbody>
                        <?php $i = 1;
                        foreach ($ims_requests as $row) { ?>

                        <tr role="row" class="odd">
                            <td class="text-center"><?php echo $i; ?></td>
                            <td class="text-center"><b><?php echo substr($row['created_on'], 0, 10); ?></b></td>
                            <td class="text-center"><b><?php echo $row['generated_by']; ?></b></td>
                            <td class="text-center"><b><?php echo $row['target_id']; ?></b></td>
                            <td class="text-center"><b><?php echo $row['request_type']; ?></b></td>
                            <td class="text-center"><b><?php echo $row['request_category']; ?></b></td>
                            <td class="text-center"><b><?php echo $row['table_str']; ?></b></td>
                            <td class="text-center"><b><?php echo $row['record_id']; ?></b></td>
                            <td class="text-center"><b><?php echo $row['op_code']; ?></b></td>
...
$(document).ready(function() {
    ...
    $('#pickers_set').on('click', function() {
        ...
        window.location = `${baseUrlMain}/main.php?dir=stats&page=requests&startp=${picker1}&endp=${picker2}`;
    });
