            ...
            <div class="card-header bg-white">
                <div class="card-header-panel d-flex align-items-center justify-content-between">
                    ...
                    <a href="#" class="btn btn-block btn-sm btn-default btn-flat border-info" 
                                data-toggle="modal" data-target="#createSubdomainModal">
                        ...
                        <td class="text-center">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="#" 
                                        ...
                                        data-xsrc="list_subdoms"
                                        data-domainid="<?php echo $subdomain['parent_domain_id']; ?>" 
                                        data-subdomid="<?php echo $subdomain['id']; ?>">Edit</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item delete_subdomain" id="delete_subdomain" href="javascript:void(0)" did="<?php echo $subdomain['id']; ?>">Delete</a>
                            </div>
                        </td>
                    </tr>
...
<!-- Modals -->
<?php include('./pages/main/subdoms/modals/create_subdom_modal.php'); ?>
...
$(document).ready(function() {
    ...
    // Delete Domain
    $('#listSubdomains').delegate('.delete_subdomain', 'click', function(e) {
        var subdomId = $(this).attr("did");
        deleteSubdomainV2(subdomId);
    })
