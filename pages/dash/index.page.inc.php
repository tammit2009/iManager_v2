...
<!-- Allow only users with 'admin' and 'company_c dashboard access' roles to access the dashboard -->
...
<!-- Only users with 'admin' role can see this section -->
...
<!-- Only users with 'Company A Dashboard Access' and admin' role can see this section -->
...
<!-- Only users with 'Company B Dashboard Access' and admin' role can see this section -->
...
<!-- Only users with 'Company C Dashboard Access' and 'admin' role can see this section -->
